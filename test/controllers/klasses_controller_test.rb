...
class KlassesControllerTest < ActionController::TestCase
  ...
  test "should create klass" do
    assert_difference('Klasse.count') do
      post :create, klass: { jahrgang: @klass.jahrgang, kennzeichnung: @klass.kennzeichnung }
    end
  ...
  test "should update klass" do
    patch :update, id: @klass, klass: { jahrgang: @klass.jahrgang, kennzeichnung: @klass.kennzeichnung }
    assert_redirected_to klass_path(assigns(:klass))
  end
