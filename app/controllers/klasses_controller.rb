class KlassesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @klass.save
        format.html { redirect_to @klass, notice: 'Klasse was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @klass.update(klass_params)
        format.html { redirect_to @klass, notice: 'Klasse was successfully updated.' }
  ...
  private
    ...
    def klass_params
      params.require(:klasse).permit(:jahrgang, :kennzeichnung)
    end
end
